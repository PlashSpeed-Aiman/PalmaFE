...
import { AnnotationService, type AnnotationUpdateDto, type Annotation } from '@/services/AnnotationService.ts'
                    ...
                    <Card style={{ marginTop: '20px', backgroundColor: '#f5f8fa' }}>
                        ...
                        <HTMLTable style={{ width: '100%' }}>
                            ...
                            <tr>
                                ...
                                <td>{annotation.results.counts["matureHealthy"] ?? 0}</td>
                            </tr>
                            <tr>
                                <td><strong>Mature (Yellow)</strong></td>
                                <td>{annotation.results.counts["matureYellow"] ?? 0}</td>
                            </tr>
                            <tr>
                                <td><strong>Mature (Dead)</strong></td>
                                <td>{annotation.results.counts["matureDead"] ?? 0}</td>
                            </tr>
                            <tr>
